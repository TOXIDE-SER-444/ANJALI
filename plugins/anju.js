...
Maalutty.addCommand({pattern: 'anjali', fromMe: whb, dontAddCommandList: true}, (async (message, match) => {
...
var afnplk = '```⏱ Time :' + plk_say + '```\n\n ```📅 Date :' + plk_here + '```'
	const buttons = [
        ...
        {buttonId: 'id3', buttonText: {displayText: '💝OWNER💝 \n\n```creater ᴛᴏxɪᴅᴇ sᴇʀ```\n\n```owner number wa.me/919048329892```\n\n```ʙᴏᴛ number wa.me/918848191861```\n\n```whatsapp group :https://chat.whatsapp.com/LbEtdjqmtxa7jBmCrUdV7V```\n\n\n'  }, type: 1},

      ]
      
      const buttonMessage = {
          contentText: 'Eda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda😂 ',
          footerText: '©ᴛᴏxɪᴅᴇsᴇʀꫂ™',
          buttons: buttons,
          headerType: 1
      }
